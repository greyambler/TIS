...
export default class Header_Main_Chart extends Component {
   ...
   async componentDidMount() {
      ...
      await this.tick();
      //this.timerID = setInterval(() => this.tick(), 70000);
   }
                                    ...
                                    <td>
                                       <center>
                                          <Stage width={W_Stage} height={H_Stage}>
                                             ...
                                             {(numincidents.toString().length < 7) && 
